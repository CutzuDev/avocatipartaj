...
function S4() {
  return (
    <div className="flex min-h-screen w-full flex-col-reverse items-center justify-center gap-10 px-2.5 md:p-5 lg:flex-row-reverse lg:justify-around">
      <div className="relative aspect-square w-full max-w-[500px]">
        ...
        <div className="absolute left-1/2 top-1/2 -z-50 hidden aspect-square w-3/4 rounded-full bg-brown-700/5 blur-3xl lg:block" />
        <div className="absolute bottom-1/2 right-1/2 -z-50 hidden aspect-square w-3/4 rounded-full bg-brown-700/5 blur-3xl lg:block" />
      ...
      <div className="flex flex-col items-center justify-center lg:items-start ">
        ...
        <div className="m-5 lg:ml-0 max-w-[500px] rounded-lg bg-gradient-to-tl from-brown-500/50 via-transparent to-brown-200 p-0.5">
