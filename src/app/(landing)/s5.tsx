  ...
  return (
    <div className="flex min-h-screen w-full flex-col-reverse items-center justify-center gap-10 px-2.5 md:p-5 lg:flex-row lg:justify-around">
      <div className="relative aspect-square w-full max-w-[500px]">
        ...
        <div className="absolute hidden lg:block right-1/2 top-1/2 -z-50 aspect-square w-3/4 rounded-full bg-brown-700/5 blur-3xl" />
        <div className="absolute hidden lg:block bottom-1/2 left-1/2 -z-50 aspect-square w-3/4 rounded-full bg-brown-700/5 blur-3xl" />
